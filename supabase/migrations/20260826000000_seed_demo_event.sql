-- Seed: evento demo + ingresso casal a R$100,00
-- Executar no Supabase SQL Editor se o seed.sql não rodou automaticamente
...
('00000000-0000-0000-0000-000000000301','00000000-0000-0000-0000-000000000201','Lote único','Ingresso para um casal',100.00,70,0,'2026-08-21 09:00-03','2026-09-19 18:00-03',2,'available')
on conflict (id) do update set
